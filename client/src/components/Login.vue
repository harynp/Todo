    ...
    <div class="cont_login">
      ...
      <div class="cont_back_info">
        <div class="cont_img_back_grey">
          <img src="https://static.cdn-cdpl.com/source/c420ea5d6888e29a87437c2d005edd57/kelas.png" alt="" />
        </div>
      </div>
      <div class="cont_forms">
        ...
        <div class="cont_form_login">
          ...
          <button class="btn_login" @click="signin()">LOGIN</button>
          <fb-signin-button :params="fbSignInParams"
          @success="onSignInSuccess" @error="onSignInError" class="fb-signin-button fb-signin-button--facebook">
            <button class="btn btn-primary" type="button" name="button">Login with Facebook</button>
